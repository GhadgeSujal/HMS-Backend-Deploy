...
public class MedicineController {
    ...
    public ResponseEntity<Medicine> getMedicinById(@PathVariable long id) throws AttributeNotFoundException{
    ...
    public ResponseEntity<Map<String, Boolean>> deleteMedicines(
